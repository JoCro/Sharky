...
function changeMobileSoundButtonsIcon(){
    ...
    document.getElementById('mobileSoundButton').setAttribute('onclick', 'activateSounds()');
}
...
function changeMobileSoundButtonsIconBack(){
    ...
    document.getElementById('mobileSoundButton').setAttribute('onclick', 'stopSounds()');
}
